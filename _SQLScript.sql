...
USE <Target Database, varchar, WorkBench>
GO

WHILE ( SERVERPROPERTY('servername') NOT IN ( '<Target Server, varchar, SomeSQLServer>' ) )
    OR ( DB_NAME() NOT IN ( '<Target Database, varchar, WorkBench>' ) )
    BEGIN
