...
( NAME = N'Aries_SQL_Working', FILENAME = N'D:\SQL\ARIES_ARCHIVE\Database\<Archive Database Name,sysname,Aries_SQL_ _20100101>.mdf' , SIZE = 3072KB , FILEGROWTH = 1024KB )
    LOG ON 
( NAME = N'Aries_SQL_Working_Log', FILENAME = N'D:\SQL\ARIES_ARCHIVE\Logs\<Archive Database Name,sysname,Aries_SQL_ _20100101>_log.ldf' , SIZE = 9216KB , FILEGROWTH = 10%)
GO
...
BACKUP DATABASE [<Archive Database Name,sysname,Aries_SQL_ _20100101>] TO DISK =
    N'D:\SQL\Backups\<Archive Database Name,sysname,Aries_SQL_ _20100101>.bak'
...
RESTORE DATABASE [<Archive Database Name,sysname,Aries_SQL_ _20100101>] FROM DISK =
    ...
    MOVE 'Aries_SQL_Working' TO 'D:\SQL\ARIES_ARCHIVE\Database\<Archive Database Name,sysname,Aries_SQL_ _20100101>.mdf', 
    MOVE 'Aries_SQL_Working_Log' TO 'D:\SQL\ARIES_ARCHIVE\Logs\<Archive Database Name,sysname,Aries_SQL_ _20100101>_Log.ldf', 
